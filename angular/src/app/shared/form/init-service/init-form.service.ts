    ...
    initForm(formComponent: FormComponent): void {
        // Сначала нужно получить значение topic_id
                ...
                for (let i = 0; i < formComponent.rows.length; i++) {
                    ...
                    if (formComponent.records[formComponent.rows[i]].active_in_topic != '0' && formComponent.records[formComponent.rows[i]].active_in_topic != null) {
                        formComponent.records[formComponent.rows[i]].active_in_topic_array = formComponent.records[formComponent.rows[i]].active_in_topic.split(',');
                    } else {
        ...
        */
                    ...
                    if (formComponent.is_date_type(formComponent.records[formComponent.rows[i]].type) && formComponent.records[formComponent.rows[i]].value == 'now') {
                    ...
                    if (formComponent.records[formComponent.rows[i]].type == 'textarea_editor') {
                        formComponent.text_area_editor_storage[formComponent.records[formComponent.rows[i]].name] = formComponent.records[formComponent.rows[i]].value;
                    }

                    if (formComponent.records[formComponent.rows[i]].type == 'parameter') {
                        formComponent.parameters_storage[formComponent.records[formComponent.rows[i]].name] = formComponent.records[formComponent.rows[i]].value;
                    }
                    ...
                    if (formComponent.records[formComponent.rows[i]].type == 'date') {
                        ...
                        if (formComponent.records[formComponent.rows[i]].value_string != '' && formComponent.records[formComponent.rows[i]].value_string != null) {
                            formComponent.form.controls[formComponent.rows[i]].patchValue(moment(formComponent.records[formComponent.rows[i]].value_string, 'DD.MM.YYYY'));
                        } else {
                            formComponent.form.controls[formComponent.rows[i]].patchValue(null);
                        }
                    }
                    ...
                    if (formComponent.records[formComponent.rows[i]].type == 'dttime') {
                        formComponent.form.controls[formComponent.rows[i]].patchValue(formComponent.records[formComponent.rows[i]].value.slice(10, 16));
                    }
                    ...
                    if (formComponent.records[formComponent.rows[i]].type == 'select_box') {
                        ...
                        if (formComponent.records[formComponent.rows[i]].value_string == '' && formComponent.records[formComponent.rows[i]].value == '') {
                            formComponent.form.controls[formComponent.rows[i]].patchValue(null);
                        }
                    ...
                    if (formComponent.records[formComponent.rows[i]].type == 'photo') {
                        formComponent.init_photo_image(formComponent.records[formComponent.rows[i]].name, formComponent.records[formComponent.rows[i]].value);
                    }


                    if (formComponent.records[formComponent.rows[i]].type == 'uploads') {
                        formComponent.init_gallery_images(formComponent.records[formComponent.rows[i]].name, formComponent.records[formComponent.rows[i]].value);
                    }
                    ...
                    if (data.get_default_value(formComponent.rows[i])) {
                        ...
                        formComponent.form.controls[formComponent.rows[i]].patchValue(formComponent.records[formComponent.rows[i]].value);
                    }
                }
        /*
